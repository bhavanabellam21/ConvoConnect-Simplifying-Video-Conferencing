          ...
          <>
            ...
            <div className="home-meet-container">
              <div className="create-meet">
                ...
                <button  data-bs-toggle="modal" data-bs-target="#staticBackdrop"><RiVideoAddFill/> Start meet</button>
              </div>
              <p>or</p>
              <div className="join-meet">
                <input type="text" placeholder='Enter ID...' onChange={(e)=> setJoinRoomId(e.target.value)} />
